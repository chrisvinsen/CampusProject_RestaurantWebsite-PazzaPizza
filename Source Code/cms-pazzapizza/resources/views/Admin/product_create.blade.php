                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group m-0">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" id =  "name-id" name = "name" placeholder = "Product Name">
                                    ...
                                    <div class="form-group m-0">
                                        ...
                                        <textarea rows="5" maxlength="1000" class="form-control" id = "description-id" name = "description" placeholder = "Product Description"></textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-6 form-group m-0">
                                            ...
                                            <input type="text" class="form-control" id = "stock-id" name = "stock" placeholder = "Product Stock">
                                            <small class="ml-1 text-danger" id="stock_err"></small>
                                        </div>
                                        <div class="col-md-6 form-group m-0">
                                            <label for="harga">Price</label>
                                            <input type="text" class="form-control" id = "price-id" name = "price" placeholder = "Product Price">
...
<script>
    ...
    $('#form-product').submit(function(event) {
        ...
        url = "{{ route('panel.product.addPost') }}";
    
        if(data.get('image') == null){
            $("#image_err").text("Image must be choose");
            error = true;
        }else{
            $("#image_err").text("");
        }
        ...
        if(!error){
            ...
            ajaxRequest = $.ajax({
                ...
                success: function(data) {
                    if (data) {
                        ...
                        swal({title : "Success!", text: "Product has been uploaded.", type: "success"}, function() {
            ...
            console.log("Cannot add new product. Please fill up all the form");
        }
    });
